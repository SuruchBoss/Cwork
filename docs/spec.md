...
| | |
|---|---|
| **Correctness** | Business rules are pure functions in `domain/` with no I/O, unit-tested: 245 backend, 17 web, 33 mobile. A 113-check e2e suite drives the real API over HTTP and runs in CI. |

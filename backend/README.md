...
| `npm test` · `test:cov` | Unit tests (184, no database needed) |
| `npm run test:e2e` | End-to-end tests (64) — needs a throwaway database, see below |
...
264 unit tests over the domain layer:

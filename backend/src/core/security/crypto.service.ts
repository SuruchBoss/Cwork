 ...
 * key rotation can decrypt old values while writing new ones.
 */
@Injectable()
export class CryptoService {
  ...
  /** For opaque tokens (refresh, reset, assessment links) stored at rest. */
  ...
  /** Keeps the last N characters searchable without ever storing plaintext. */
  static lastChars(value: string, count = 4): string {

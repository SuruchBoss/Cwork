...
- LATE_CAPTURE: การลงเวลาออฟไลน์ที่ส่งเข้าระบบช้ากว่าเวลาที่บันทึกไว้มาก (เกินเพดานที่ตั้งไว้) — บันทึกไว้แล้วและรอหัวหน้ายืนยัน มักเป็นเพราะไม่มีสัญญาณ ไม่ใช่การโกงเสมอไป

...
tests, 29 web, 35 mobile, plus a 207-check end-to-end suite that drives the real
...
- Every suite passes, in CI, on every push — 324 backend unit tests, 29 web,
  35 mobile, 207 end-to-end checks against the real API over HTTP.
